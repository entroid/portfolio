...
export function CaseStudyCard({
  ...
  return (
    <Link
      href={`/work/${meta.slug}`}
      className="group block border border-grid-border p-4 transition-colors duration-150 hover:border-accent focus-visible:border-accent focus-visible:outline-none md:p-6"
    >
